      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors duration-200">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-michroma text-lg font-semibold text-white mb-6">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a 
                    href={link.href}
                    className="text-[#CBD5E0] hover:text-white transition-colors duration-200 text-sm"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@pleiadesystems.com" className="text-[#CBD5E0] text-sm hover:text-white transition-colors duration-200">
                    info@pleiadesystems.com
                  </a>
                </div>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <div className="text-white font-medium text-sm mb-1">Business Hours</div>
                  <p className="text-[#CBD5E0] text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-[#CBD5E0] text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Pleiades Systems. All rights reserved.
            </div>
